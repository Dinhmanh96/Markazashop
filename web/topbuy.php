...
<div class="panel panel-default panel-slide panel-buy">
  <div style="background-color: #00b3b3; height: 40px; border-radius: 0px;" class="panel-heading">
		<span class="title" style="color: #fff; font-size: 16px;">Top sản phẩm mua nhiều</span>
  ...
  <div class="panel-footer text-right">
  	<center><a href="index.php?page_layout=topbuy"><button type="button" class="btn btn-primary">Xem thêm >></button></a></center>
  </div>
</div>