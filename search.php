...
$("#input").watermark("Tìm kiếm theo tên sản phẩm, thương hiệu sản phẩm, ...");	// Watermart cho khung nhập
...
<div class="col-xs-6 col-sm-7 col-md-7 search" >
						<!-- <div class="input-group add-on" > -->
						<form method="post" class="input-group add-on" action="index.php?page_layout=timkiem">
